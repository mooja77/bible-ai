...
1. The exact KJV JSON is acquired from a repository whose pinned README applies
   ...
   to their respective owners. That compilation notice must not be collapsed
   into the underlying KJV text's public-domain status.
...
3. The two Strong's files contain an exact embedded notice saying the 2009/2010
   ...
   Creative Commons version. The exact license text/version, attribution, and
   share-alike treatment therefore remain open.
4. OpenBible.info labels the cross-reference content “Creative Commons
   Attribution” but the referenced page does not identify a CC version. The
   release needs a version-specific conclusion or written clarification.
...
| openbible-xrefs | snapshot acquired 2026-05-02 | `533e055792af278032f87ab8e4cce6c1b3899f776cea1c711cfd290c2052b4b2` | [Official cross-reference page and license notice](https://www.openbible.info/labs/cross-references/); [project background](https://www.openbible.info/blog/2010/04/new-in-labs-cross-references/) | Attribution is required; the public notice does not specify a CC version. | Resolve exact license version, required attribution, modification marking, and derived/export obligations. **Open; release-critical.** |
| strongs-greek | `openscriptures/strongs@0acd2f251c2d35ff8db2dece4e0593979d3ac223` | `7624ee738ae47e80f1a352223e28a26d011c9cd4898822cee52f47a010c04efd` | [Pinned source](https://raw.githubusercontent.com/openscriptures/strongs/0acd2f251c2d35ff8db2dece4e0593979d3ac223/greek/strongs-greek-dictionary.js); exact file header: “Copyright 2009, Open Scriptures. CC-BY-SA. Derived from XML.” | CC BY-SA applies to the JSON version, but its version and full license text are not identified in the artifact/repository root. | Obtain a version-specific license conclusion; define attribution and share-alike handling for bundled data, exports, and derived indexes. **Open; release-critical.** |
| strongs-hebrew | `openscriptures/strongs@0acd2f251c2d35ff8db2dece4e0593979d3ac223` | `5ce6aeed551c709f49bcfa341cadf2f34bc7599b85d9de9e6ac2ecbf60fc3739` | [Pinned source](https://raw.githubusercontent.com/openscriptures/strongs/0acd2f251c2d35ff8db2dece4e0593979d3ac223/hebrew/strongs-hebrew-dictionary.js); exact file header: “Copyright 2010, Open Scriptures. CC-BY-SA. Derived from XML.” | Same unresolved CC version/full-text issue as the Greek JSON. | Obtain version-specific terms; define attribution and share-alike handling. **Open; release-critical.** |
...
2. Resolve the four release-critical issues above. If any cannot be resolved,
   remove/replace that source and rebuild the corpus rather than marking it
   approved.
